<html>
    ...
    <body>
        ...
        <h2>Display Wait List Details</h2>
        <form method="GET" action="displayWaitList.php"> <!--refresh page when submitted-->
        ...
        function printResult($result) { //prints results from a select statement
            echo "<br>Retrieved data from the query:<br>";
            echo "<table>";
            echo "<tr><th>Employee ID (PK) | </th><th>First Name |  </th><th>Last Name |  </th><th> WaitList ID | </th><th>Wait From </th></tr>";

            while ($row = OCI_Fetch_Array($result, OCI_BOTH)) {
                echo "<tr><td>" . $row["EMPLOYEEID"] . "</td><td>" . $row["FIRSTNAME"] . "</td><td>" . $row["LASTNAME"] .  "</td><td>" . $row["WAITLISTID"] . 
                "</td><td>" . $row["WAITFROM"] ."</td></tr>"; //or just use "echo $row[0]"
            }
        ...
        function handleInsertRequest() {
            ...
            executeBoundSQL("insert into employeeInfo values (:bind1, :bind2, :bind3, :bind4, :bind5)", $alltuples);
            OCICommit($db_conn);
        }
        ...
        function handlePrintRequest() {
            ...
            $result = executePlainSQL("SELECT e.employeeid, firstName, lastName, waitListId, waitFrom
