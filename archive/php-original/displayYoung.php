<html>
    <head>
        <title>Display Youngest Employee</title>
    </head>
    ...
    <body>
        ...
        <h2>Display Youngest Employee</h2>
        <form method="GET" action="displayYoung.php"> <!--refresh page when submitted-->
        ...
        function printResult($result) { //prints results from a select statement
            ...
            echo "<table>";
            echo "<tr><th>Employee ID |  </th><th> </th></tr>";

            while ($row = OCI_Fetch_Array($result, OCI_BOTH)) {
                echo "<tr><td>" . $row["EMPLOYEEID"] . $row["AGE"] ."</td></tr>"; //or just use "echo $row[0]"
            }
        ...
        function handlePrintRequest() {
            ...
            $result = executePlainSQL("SELECT employeeId, avg (e.age)
            from employeeInfo e
            group by employeeId
