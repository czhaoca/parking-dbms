<html>
    ...
    <body>
        ...
        <form method="GET" action="displayEmployee.php"> <!--refresh page when submitted-->
        ...
        function printResult($result) { //prints results from a select statement
            ...
            echo "<table>";
            echo "<tr><th>Employee ID (PK) | </th><th>First Name | </th><th>Last Name </th></tr>";

            while ($row = OCI_Fetch_Array($result, OCI_BOTH)) {
                echo "<tr><td>" . $row["EMPLOYEEID"] . "</td><td>" . $row["FIRSTNAME"] . "</td><td>" . $row["LASTNAME"] .  "</td><td>" . $row["EMPLOYEESTATUS"] . 
                "</td><td>" . $row["DEPARTMENTID"] ."</td></tr>"; //or just use "echo $row[0]"
            }
        ...
        function handlePrintRequest() {
            ...
            $result = executePlainSQL("SELECT employeeid, firstname, lastname FROM employeeInfo");
                printResult($result);
