<html>
    <head>
        <title>Display Employees Still in Wait List</title>
    </head>
    ...
    <body>
        ...
        <h2>Display Employee Still in Wait List (waiting to get a reserved parking)</h2>
        <form method="GET" action="displayWaitListEmployee.php"> <!--refresh page when submitted-->
        ...
        function printResult($result) { //prints results from a select statement
            ...
            while ($row = OCI_Fetch_Array($result, OCI_BOTH)) {
                echo "<tr><td>" . $row["EMPLOYEEID"] . "</td><td>" . $row["FIRSTNAME"] . "</td><td>" . $row["LASTNAME"] . "</td></tr>"; //or just use "echo $row[0]"
            }
        ...
        function handlePrintRequest() {
            ...
            $result = executePlainSQL("SELECT employeeId, firstName, lastName
            from employeeInfo e 
            where not exists 
            (select p.parkingNum 
            from parkingInfo p 
